...
//            System.out.println(cluster);
            ...
            mean1 =Double.parseDouble(new DecimalFormat("##.##").format(mean1));
            ...
            mean4 =Double.parseDouble(new DecimalFormat("##.##").format(mean4));
            String mean44=Double.toString(mean4);

            double mean5=s5/cluster.size();
            mean5 =Double.parseDouble(new DecimalFormat("##.##").format(mean5));
            ...
            mean7 =Double.parseDouble(new DecimalFormat("##.##").format(mean7));
